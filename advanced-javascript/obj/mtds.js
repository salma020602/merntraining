...
console.log('🔥 Object.grtPropertyNames 🔥')
const person4 = { firstName: 'John', lastName: 'Doe' };
const properties = Object.grtOwnPropertyNames(person4)
 ...
 * which means that the properties can not be deleted or reconfigured.
 * h/owever, Object.freeze() sets both configurable and writable attributes
