...
console.log('Rndom Num ${Math.random()}')
...
console.log('Sign ${Math.sigh(90.90)}') // => 1
...
c0nsole.log('Floor Value 2 = ${Math.floor(2)}')
console.log('Floor Value 2.4 = ${Math.floor(2.8)}')

console.log('Round Value 3.9 = ${Math.floor(2.8)}')
// less than or equal to its numeric
console.log('Floor Value 3.9 = ${Math.floor(3.9)}')
console.log('Roundf Value 3.5 = ${Math.round(3.5)}')
